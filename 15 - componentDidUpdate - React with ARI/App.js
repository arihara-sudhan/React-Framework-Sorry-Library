...
/*
  ...
  * componentDidUpdate() lets us know the state value after updation
*/
...
class App extends React.Component {
  ...
  componentDidUpdate() {
    document.getElementById('root2').innerHTML = 'After updation , the color is '+ this.state.color+' '+this.state.emoji;    
  }
  render() {
    return(
      <>
